...
cd /usr/local/src
[ -f httpd-2.2.31.tar.bz2  ] || wget  http://mirrors.aliyun.com/apache/httpd/httpd-2.2.31.tar.bz2
tar -xjf  httpd-2.2.31.tar.bz2 && cd httpd-2.2.31
#check_ok
./configure \
...
make && make install
check_ok
ln -s /usr/local/httpd-2.2.31  /usr/local/httpd
